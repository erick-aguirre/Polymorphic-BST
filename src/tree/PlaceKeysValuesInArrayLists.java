...
public class PlaceKeysValuesInArrayLists<K, V> implements TraversalTask<K, V> {
	...
	ArrayList<K> keyArrayList;
	ArrayList<V> valueArrayList;
	...
	public PlaceKeysValuesInArrayLists() {
		...
		keyArrayList = new ArrayList<K>();
		valueArrayList = new ArrayList<V>();
	...
	public ArrayList<K> getKeys() {
		...
		ArrayList<K> newone = keyArrayList;
	...
	public ArrayList<V> getValues() {
		...
		ArrayList<V> newone = valueArrayList;
